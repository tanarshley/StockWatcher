              ...
              <div class="card border-0 shadow-sm p-3 mb-5 bg-white rounded">
                  ...
                  <div class="card-body">
                    ...
                    @endif
                      ...
                      <form action="{{ route('ForgetPasswordConstituentPost') }}" method="POST">
                          @csrf
                          <div class="form-group row">
                              <label for="email_address" class="col-md-4 col-form-label text-md-right">E-Mail Address</label>
                              <div class="col-md-6">
                                  <input type="text" id="email_address" class="form-control" name="constituent_email" placeholder="Enter your email address" required autofocus>
