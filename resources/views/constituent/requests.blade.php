            ...
            <nav class="nav">
                <div>
                    <a href="{{ route('constituent.requests') }}" class="nav_logo"> <img src="{{ asset('StockWatcher-icon.png') }}" style="width: auto; height: 60px; margin-left: -44px; margin-right: -32px;"> <span class="nav_logo-name">StockWatcher</span> </a>
                        <div class="nav_list"> <a href="{{ route('constituent.requests') }}" class="nav_link active"> <i class='bx bx-capsule nav_icon'></i> <span class="nav_name">Requests</span> 
                    </a> 
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="alert alert-success" role="alert" style="font-size: 1rem;">
                                                                        <h5 class="alert-heading">Request Approved!</h5>
                                                                        <p>Present this approved request to the barangay health worker to claim your medicine.</p>
                                                                        <p class="text-end">Approved at {{ date('d M Y', strtotime($request->updated_at)) }}</p>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <div class="form-group mb-3">
                                                                                <label for="constituentName">Name</label>
                                                                                <input type="text" class="form-control bg-white" id="constituentName" value="{{ $LoggedConstituent->constituent_name }}" disabled style="font-weight: 600;">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col">
                                                                            <div class="form-group mb-3">
                                                                                <label for="householdID">Household ID</label>
                                                                                <input type="text" class="form-control bg-white" id="householdID" value="{{ $LoggedConstituent->household_id }}" disabled style="font-weight: 600;">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                ...
                                                                <div class="modal-footer border-0">
                                                                    @if($request->request_status == 'Pending')
                                                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#cancelRequest{{ $request->medicine_request_id }}" data-bs-dismiss="modal">Cancel Request</button>
                                                                    @elseif($request->request_status == 'Approved')
