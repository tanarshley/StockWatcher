            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a class="nav-link active text-white" aria-current="page" href="{{ route('stockwatcher.contact-us') }}">{{__('Contact Us')}}</a>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <p class="lead text-center">We are here to help you with any questions you may have about stockwatcher and our services.</p>
                    <p class="lead text-center">You can reach us at our email address: <br>stockwatcher.oldcabalan@gmail.com</p>
                    <p class="lead text-center">Or you can reach us at our barangay phone number: <br>+63 947 266 0546</p>
                </div>
            </div>

            <footer class="d-flex flex-wrap justify-content-center align-items-center py-2 border-top" style="padding: 10px 20px 10px 20px; margin-top: 22.5%;">
