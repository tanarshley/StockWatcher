    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row text-center">
                <img src="{{ asset('icons/stockwatcher-icon.png') }}" alt="StockWatcher" class="img-fluid mx-auto" style="max-height: auto; max-width: 600px;">
                <h1 class="display-4">{!! $title !!}</h1>
                <p class="lead">{!! $title !!} is a web application for Barangay Old Cabalan Health Center to monitor the stocks <br>of their medicines and its supplies in their health center easily and efficiently. <br> 
            It is also integrated with Online Medicine Request for its constituents.</p>
            </div>
            <div class="btn-group" style="text-align: center; margin: 0 auto; display: block;">
                <button class="btn btn-lg btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#loginChoiceModal">{{__('Get Started')}}</button>
            </div>
        
            <footer class="d-flex flex-wrap justify-content-center align-items-center py-2 border-top" style="padding: 10px 20px 10px 20px; margin-top: 6%;">
